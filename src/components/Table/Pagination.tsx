      ...
      <div className="flex items-center space-x-2">
        ...
        >
          <div className="relative">
            <Listbox.Button
              ref={trigger}
              className="relative w-16 flex items-center justify-center space-x-1.5 text-sm font-medium bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-800/70 pl-3 pr-8 py-1.5 rounded-lg cursor-pointer ring-1 ring-slate-950 dark:ring-slate-800 ring-opacity-5"
            >
            ...
            <Portal>
              <Listbox.Options
                ref={container}
                className="w-16 mt-1 max-h-60 overflow-auto rounded-lg bg-white dark:bg-slate-950 py-1 text-sm shadow-lg ring-1 ring-slate-950 dark:ring-slate-800 ring-opacity-5 focus:outline-none"
              >
