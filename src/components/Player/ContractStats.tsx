            ...
            <table className="min-w-full divide-y divide-slate-300 dark:divide-slate-700">
              <thead>
                <tr>
                  ...
                  <th
                    scope="col"
                    className="last:pr-0 whitespace-nowrap px-1.5 sm:px-2 py-1 text-sm sm:text-base text-center font-semibold tracking-wide text-slate-700 dark:text-slate-200 uppercase"
                  >
                    Min
                  </th>
                  <th
                  ...
                  <th
                    scope="col"
                    className="whitespace-nowrap px-1.5 sm:px-2 py-1 text-sm sm:text-base text-center font-semibold tracking-wide text-slate-700 dark:text-slate-200 uppercase"
                  >
                    Max
                  </th>
                </tr>
