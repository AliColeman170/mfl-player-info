...
export async function FavouriteButton({ playerId }) {
  ...
  return (
    <ToggleFavouriteButton
      ...
      className="flex items-center justify-center space-x-1.5 text-sm font-medium bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-800/50 px-2.5 py-2 sm:px-3 rounded-lg cursor-pointer ring-1 ring-slate-950 dark:ring-slate-800 ring-opacity-5 disabled:opacity-50 disabled:pointer-events-none"
    />
  );
}
