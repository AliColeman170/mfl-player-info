...
const POSITIONS = [
  'ST', 'CF', 'LW', 'RW', 'CAM', 'LM', 'RM', 'CM', 'CDM', 'LWB', 'RWB', 'LB', 'RB', 'CB', 'GK'
] as const
...
export const filterParsers = {
  ...
  primaryPositions: parseAsArrayOf(parseAsStringEnum([...POSITIONS])).withDefault([]),
  secondaryPositions: parseAsArrayOf(parseAsStringEnum([...POSITIONS])).withDefault([]),
  ...
  // Single select
  preferredFoot: parseAsStringEnum([...PREFERRED_FOOT]).withOptions({ clearOnDefault: true }),
  ...
  sortOrder: parseAsStringEnum(['asc', 'desc'] as const).withOptions({ clearOnDefault: true }),
}
...
export const FILTER_GROUPS = {
  ...
  RATINGS: [
    ...
    'paceMin', 'paceMax',
    'shootingMin', 'shootingMax', 
    'passingMin', 'passingMax',
    'dribblingMin', 'dribblingMax',
